...
<body>
    ...
    <div class="container">
        ...
        <article class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            <h1 class="title-news text-justify">Para Conhecer.</h1>
            
            <img src="images/a-6.jpg." alt="banco hsbc de Curitiba, famoso por cantatas natalinas. " class="col-xs-12 col-sm-12 col-md-12 col-lg-12 img-responsive"> 
