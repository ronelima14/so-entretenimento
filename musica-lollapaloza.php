...
<head>
    ...
    <title>Sem saber da morte de Kurt, Nirvana cancelou show no Lolla há 20 anos</title>
...
<body>
    ...
    <div class="container">
        ...
        <article class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
        	<h1 class="title-news text-justify">Sem saber da morte de Kurt, Nirvana cancelou show no Lolla há 20 anos<p class="small">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis minus officiis adipisci possimus inventore quaerat eius molestiae in aperiam. Tempora vero vel officiis, quis illo itaque omnis consectetur, voluptatibus repudiandae.</p></h1>
            <img src="images/musica-lollapaloza.jpg" alt="imagem da banda Nirvana" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 img-responsive">
