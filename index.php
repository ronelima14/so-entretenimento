    ...
    <div class="container">
        ...
        <article class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            <a href="musica-fireflight.php">
                <img src="images/musica-fireflight.jpg" alt="imagem da banda Fireflight" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h2 class="news text-center">Fireflight - banda de rock gospel - começa a fazer sucesso mundialmente</h2>
            </a>
        </article>
        <section>
            <a href="tv-series-heroes.php">
            ...
            <a href="lazer-noticia-1.php">
                <img src="images/a-6.jpg" alt="imagem de teatro" class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            </a>
        </section>
       ...
       <section>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <a href="filmes-noticias.php"><img src="images/self-noticia-gde.jpg" alt="imagem de pessoas tirando self" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></a>
                <h2 class="news text-center">Elenco</h2>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        ...
        <section>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <a href="tv-novela-o-clone.php"><img src="images/tv-novela-o-clone.jpg" alt="imagem da novela O Clone" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></a>
                <h2 class="news text-center">Uma Novela de grande Sucesso "O Clone"</h2>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        ...
        <section>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <a href="lazer.php"><img src="images/a-1.jpg" alt="imagem de lugar à luz de velas" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></a>
                <h2 class="news text-center">Sugestões de lugares Românticos.</h2>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        ...
        <section>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <a href="hq-gibi10.php"><img src="images/hq-noticia10.jpg" alt="imagem do Naruto" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></a>
                <h2 class="news text-center">Tudo sobre o Naruto e seus amigos!</h2>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
