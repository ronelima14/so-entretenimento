...
<body>
    ...
    <div class="container">
        ...
        <article class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
        	<h1 class="title-news text-justify">Um Lugar Para dar Risada.</h1>
            <h3 class="small">Palmas, Risadas e Sorrisos</h3>
            <img src="images/a-7.jpg" alt="três artistas em uma encenação com cara de espanto ao ouvirem um segredo." class="col-xs-12 col-sm-12 col-md-12 col-lg-12 img-responsive"> 
...
Mauris lacinia vestibulum vulputate. Nunc luctus, tellus in tristique volutpat, nisl ipsum luctus augue, nec vulputate nibh felis vitae felis. Proin id diam eget sem rutrum hendrerit sit amet vel justo. Suspendisse ultricies quam vitae convallis volutpat. Cras vitae arcu non mi posuere aliquam. Aenean vel felis interdum, consectetur diam aliquam, pulvinar ante. In magna erat, eleifend id nisi vitae, scelerisque pharetra tellus. Morbi fermentum velit neque, eget ullamcorper nisl interdum vitae. Nunc sed felis ipsum. Proin dolor nisl, aliquam non nulla vel, rutrum interdum sem. Integer dictum imperdiet metus, vitae tincidunt libero malesuada vitae.</p>
        ...
        <aside class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <a href="lazer-noticia-1.php"> <img src="images/a-6.jpg" "banco hsbc de Curitiba, famoso por cantatas natalinas. " class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> </a>
            ...
            <h2 class="news">Achei que escrever algo aqui seria legal. Como vai você?</h2>
            <a href="lazer-noticia-4.php"><img src="images/a-9.jpg" alt="Casal se abraça em restaurante, clima aconchegante à luz de velas." class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> </a>
            <h2 class="news">Achei que escrever algo aqui seria legal. Como vai você?</h2>
        </aside>
        <!-- TV -->
