...
<body>
    ...
    <div class="container">
        ...
        <article class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            ...
            <img src="images/a-8.jpg." alt="imagem do Masp em São Paulo. Prédio suspenso por quatro colunas." class="col-xs-12 col-sm-12 col-md-12 col-lg-12 img-responsive"> 
