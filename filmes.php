...
<body>
    ...
    <div class="container">
        ...
        <section id="noticia" class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          ...
          <img src="images/premier01-noticia.jpg" alt="imagem de teste" class="img-responsive col-md-6">
          <img src="images/premier02-noticia.jpg" alt="imagem de teste" class="img-responsive col-md-6">
        ...
        <section id="em-breve" class="col-sm-12 col-md-8 col-lg-8" >
           ...
           <a href="padrao-noticia.php"> <img src="images/tris-convergente.jpg" alt="imagem de teste" class="img-responsive" ></a>
        ...
        <section class="col-xs-12 col-sm-4 col-md-4 col-lg-4">    
            ...
            <div class="col-md-3 col-sm-12">
                <a href="padrao-noticia.php"> <img src="images/007-contra-spectre-poster.jpg" alt="imagem de teste" class="img-responsive"></a>
            </div>
            <div class="col-md-9">
           ...
           <div class="row">
            <div class="col-md-3 col-sm-12">
            <a href="padrao-noticia.php"><img src="images/jogos-vorazes-poster.jpg" alt="imagem de teste" class="img-responsive"></a>
            </div>
            <div class="col-md-9">
                <p><b>Jogos Vorazes: A Esperança-Parte2</b></p>
                <p>PARIS FILMES</p>
            ...
            <div class="row">
            <div class="col-md-3 col-sm-12">
            <a href="padrao-noticia.php"> <img src="images/alianca-do-crime.jpg" alt="imagem de teste" class="img-responsive"></a>
            </div>
            <div class="col-md-9">
           ...
           <div class="row">
            <div class="col-md-3 col-sm-12">
            <a href="padrao-noticia.php"><img src="images/o-reino-gelado-2.jpg" alt="imagem de teste" class="img-responsive"></a>
            </div>
            <div class="col-md-9">
