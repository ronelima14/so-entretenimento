...
<body>
    ...
    <div class="container">
        ...
        <article class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
        	<h1 class="title-news text-justify">Críticas: Ponte dos Espiões e O Reino Gelado<p class="small">Por José de Abreu</p></h1>
            <img src="images/ponte-dos-espioes.jpg" alt="imagem de capa do Filme Ponte dos Espiões" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 img-responsive">
            <img src="images/o-reino-gelado-2.jpg" alt="imagem de capa do Filme Ponte dos Espiões" class="col-xs-12 col-sm-12 col-md-6 col-lg-6 img-responsive">
