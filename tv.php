...
<body>
    ...
    <div class="container">
        ...
        <section class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel-heading">     
                        <div  class="container tv-container"><h2 class="text-center tv-title" >SERIES</h2>
            				</div> <!-- panel-title --> 
            			</div><!-- panel-heading --> 
        ...
        <section class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            	<div class="panel-heading">     
            	  	<div class="panel-title" id="border-novelas">
            	  		<div  class="container tv-container">               				
        				<h2 class="text-center tv-title">Humor</h2>
        				</div><!-- container tv-container -->
            		</div> <!-- panel-title --> 
            	</div> <!-- panel-heading -->                
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            </div><!--section class="col-xs-12 col-sm-12 col-md-12 col-lg-12" -->
        </section>    
        <section class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="panel-heading">     
				   		...
				   		<div class="container tv-container">  
				   			<h2 class="text-center tv-title">HISTORIA</h2>
				   			</div>
            				</div> <!-- panel-title --> 
            	</div><!-- panel-heading -->            
